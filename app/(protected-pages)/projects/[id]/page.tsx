...
export default function ProjectDashboard() {
    ...
    if (id) {
      ...
      const fetchProject = async () => {
        ...
        setProject({
          ...
          awsResources: [
            { type: 'EC2 Instances', count: 5, details: 'Running in us-west-2' },
            { type: 'S3 Buckets', count: 3, details: 'Total storage: 500GB' },
            { type: 'RDS Databases', count: 2, details: 'MySQL and PostgreSQL' },
            { type: 'Lambda Functions', count: 10, details: 'Various microservices' },
            { type: 'ECS Clusters', count: 1, details: '3 services running' },
            { type: 'CloudFront Distributions', count: 2, details: 'For web and API' },
          ],
        });
      };
  ...
  return (
    <div className="p-4 relative">
      ...
      <h1 className="text-3xl font-bold mb-4 mt-16">{project.name} Dashboard</h1>
